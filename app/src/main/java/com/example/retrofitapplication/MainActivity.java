...
//
//            @Override
//            public void onResponse(retrofit2.Call<Pojo> call, Response<Pojo> response) {
//                if (response.isSuccessful())
//                {
//                    recycleadapter adapter = new recycleadapter(response.body().getData());
//                    recycle.setAdapter(adapter);
...
//
//            @Override
//            public void onFailure(retrofit2.Call<Pojo> call, Throwable t) {
